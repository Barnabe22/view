<template>
    <div>
        <h2 class="rapportTitleStyle">Suppression du poste # {{posteId}}</h2>
        <div class="contentStyle">
            <strong class="demandStyle">Voulez vous vraiment supprimer le poste {{posteId}} ? </strong> 
...
export default {
    ...
    methods:{
        ...
        performDelete(){
            ...
            Vue.axios.delete(this.$store.state.baseUrl+"/postes/" + this.posteId, {headers})
            .then(() => {
