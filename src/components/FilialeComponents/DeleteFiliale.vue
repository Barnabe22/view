<template>
    <div>
        <h2 class="rapportTitleStyle">Suppression de la filiale # {{filialeId}}</h2>
        <div class="contentStyle">
            <strong class="demandStyle">Voulez vous vraiment supprimer la filiale {{filialeId}} ? </strong> 
...
export default {
    ...
    methods:{
        ...
        performDelete(){
            ...
            Vue.axios.delete(this.$store.state.baseUrl+"/filiales/" + this.filialeId,{headers})
            .then(() => {
