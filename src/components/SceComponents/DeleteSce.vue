<template>
    <div>
        <h2 class="rapportTitleStyle">Suppression du service # {{sceId}}</h2>
        <div class="contentStyle">
            <strong class="demandStyle">Voulez vous vraiment supprimer le service {{sceId}} ? </strong> 
...
export default {
    ...
    methods:{
        ...
        performDelete(){
            ...
            Vue.axios.delete(this.$store.state.baseUrl+"/sce/" + this.sceId,{headers})
            .then(() => {
